...
if(!$con)
{
$error = 'Database connection failed. Check PostgreSQL credentials.';
}
else
{

$username =  pg_escape_string($con,trim($_POST['username']));
         ...
         <div class="row ">
                ...
                <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1">
                            ...
                            <div class="panel-body" style="background-color: #E2E2E2; margin-top:50px; border:solid 3px #0e0e0e;">
							  <h3 class="myhead">GYM Management System</h3>
